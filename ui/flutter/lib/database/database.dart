...
const String _torBoxApiKey = 'torBoxApiKey';
const String _torBoxDownloadDir = 'torBoxDownloadDir';
...
class Database {
  ...
  void saveTorBoxApiKey(String key) {
    box.put(_torBoxApiKey, key);
  }

  String? getTorBoxApiKey() {
    return box.get(_torBoxApiKey) as String?;
  }

  void saveTorBoxDownloadDir(String dir) {
    box.put(_torBoxDownloadDir, dir);
  }

  String? getTorBoxDownloadDir() {
    return box.get(_torBoxDownloadDir) as String?;
  }
}
